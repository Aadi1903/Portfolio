    ...
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-wqf-dark font-heading">
      <div className="w-64">
        <div className="flex justify-between items-end mb-2">
          <div className="text-wqf-light/95 text-xs font-bold uppercase tracking-widest">Bootstrapping Infra...</div>
        ...
        <div className="mt-4 animate-pulse text-wqf-teal text-[13px] tracking-widest uppercase">
          [Terraform Apply...]
        </div>
      </div>
    </div>
